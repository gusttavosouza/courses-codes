...
export type CreationSubscriberMutationVariables = Exact<{
  email?: InputMaybe<Scalars['String']>;
  name?: InputMaybe<Scalars['String']>;
}>;


export type CreationSubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreationSubscriberDocument = gql`
    mutation CreationSubscriber($email: String = "", $name: String = "") {
  createSubscriber(data: {email: $email, name: $name}) {
    id
  }
}
    `;
export type CreationSubscriberMutationFn = Apollo.MutationFunction<CreationSubscriberMutation, CreationSubscriberMutationVariables>;

/**
 * __useCreationSubscriberMutation__
 *
 * To run a mutation, you first call `useCreationSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreationSubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [creationSubscriberMutation, { data, loading, error }] = useCreationSubscriberMutation({
 *   variables: {
 ...
 * });
 */
export function useCreationSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<CreationSubscriberMutation, CreationSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreationSubscriberMutation, CreationSubscriberMutationVariables>(CreationSubscriberDocument, options);
      }
export type CreationSubscriberMutationHookResult = ReturnType<typeof useCreationSubscriberMutation>;
export type CreationSubscriberMutationResult = Apollo.MutationResult<CreationSubscriberMutation>;
export type CreationSubscriberMutationOptions = Apollo.BaseMutationOptions<CreationSubscriberMutation, CreationSubscriberMutationVariables>;
